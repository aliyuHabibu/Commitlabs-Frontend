  ...
  return (
    <header className="w-full space-y-4 sm:space-y-6">
      ...
      >
        <ArrowLeft
          aria-hidden="true"
          className="w-4 h-4 group-hover:-translate-x-0.5 transition-transform motion-reduce:group-hover:translate-x-0"
        />
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
        ...
        >
          <Share2
            aria-hidden="true"
            className="w-4 h-4 group-hover:rotate-6 transition-transform motion-reduce:group-hover:rotate-0 motion-reduce:transition-none"
          />
          <span>Share</span>
        </button>
      </div>
